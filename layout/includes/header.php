...
theme_caixa_initialise_zoom($PAGE);
$setzoom = theme_caixa_get_zoom();

theme_caixa_initialise_full($PAGE);
$setfull = theme_caixa_get_full();
...
<head>
    ...
    <link rel="stylesheet" href="<?php p($CFG->httpswwwroot) ?>/theme/caixa/style/font-awesome.min.css">
...
// Fixed header.
        ...
        // Login button.
                                    ...
                                    <form action="<?php p($wwwroot) ?>/login/index.php" method="post">
                                        ...
                                        placeholder="<?php echo get_string('loginplaceholder', 'theme_caixa'); ?>" size="10">
                                        <input style="height: 12px; padding-bottom: 4px;" type="password" name="password" 
                                        placeholder="<?php echo get_string('passwordplaceholder', 'theme_caixa'); ?>"  size="10">
                                        <button class="btn-login" type="submit"><?php echo get_string('logintextbutton', 'theme_caixa'); ?></button>
                                    </form>
                                    <?php
                                    ...
                                    <form action="<?php p($wwwroot) ?>/login/index.php" method="post">
                                        <button class="btn-login" type="submit">
                                            <?php echo get_string('logintextbutton', 'theme_caixa'); ?>
                                        </button>
                                    </form>
                                    <?php
                                }
        ...
        <li>
            <a href="<?php p($CFG->wwwroot) ?>/blog/index.php"
                title="<?php echo get_string('enableblog', 'theme_caixa') ?>">
                <i class="fa fa-rss"></i>
                <?php echo get_string('enableblog', 'theme_caixa') ?>
            </a>
        </li>
        <?php
    }
    ...
    <li>
        <a href="<?php p($CFG->wwwroot) ?>/mod/forum/user.php"
            title="<?php echo get_string('enableposts', 'theme_caixa') ?>">
            <i class="fa fa-commenting"></i>
            <?php echo get_string('enableposts', 'theme_caixa') ?>
        </a>
    </li>
    <?php
}
...
<li>
    <a href="<?php p($CFG->wwwroot) ?>/report/myfeedback/index.php"
        title="<?php echo get_string('enablefeed', 'theme_caixa') ?>">
        <i class="fa fa-bullhorn"></i>
        <?php echo get_string('enablefeed', 'theme_caixa') ?>
    </a>
</li>
<?php
}
...
// Social icons.
    ...
    ?>
<div class="poder-publico">
    <?php
// Site title or logo.
    echo $OUTPUT->get_logo_center();
    ?>
</div>
    <?php
// Search box.
                        ...
                        <div class="nav-collapse collapse ">
                            ...
                            <ul class="nav pull-right">
                                ...
                                if (isloggedin()) {
                                    ...
                                    <li class="hbl">
                                     <a href="#" class="moodlezoom" title="<?php echo get_string('hideblocks', 'theme_caixa') ?>">
                                         <i class="fa fa-indent fa-lg"></i>
                                         <span class="zoomdesc"><?php echo get_string('hideblocks', 'theme_caixa') ?></span>
                                     </a>
                                 </li>
                                 <li class="sbl">
                                     <a href="#" class="moodlezoom" title="<?php echo get_string('showblocks', 'theme_caixa') ?>">
                                         <i class="fa fa-outdent fa-lg"></i>
                                         <span class="zoomdesc"><?php echo get_string('showblocks', 'theme_caixa') ?></span>
                                     </a>
                                 </li>
                                 <?php
                             }
                             ...
                             <li class="hbll">
                                <a href="#" class="moodlewidth" title="<?php echo get_string('fullscreen', 'theme_caixa') ?>">
                                    <i class="fa fa-expand fa-lg"></i>
                                    <span class="zoomdesc"><?php echo get_string('fullscreen', 'theme_caixa') ?></span>
                                </a>
                            </li>
                            <li class="sbll">
                                <a href="#" class="moodlewidth" title="<?php echo get_string('standardview', 'theme_caixa') ?>">
                                    <i class="fa fa-compress fa-lg"></i>
                                    <span class="zoomdesc"><?php echo get_string('standardview', 'theme_caixa') ?></span>
                                </a>
                            </li>
                            <?php
                        }
