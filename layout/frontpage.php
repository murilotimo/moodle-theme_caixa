...
<div id="boottest" style="min-height: 500px; width: 80%; margin: 0 auto;">
<br><br>
...
<div class="tab-content">
  <div class="tab-pane active" id="home"> cont1</div>
  <div class="tab-pane" id="profile"> cont 2</div>
  <div class="tab-pane" id="messages">cont3</div>
...
Anim pariatur cliche...
 ...
 <div style="padding-bottom: 24px;" class="bs-docs-example">
          <a id="pover" data-content="And here's some amazing content. It's very engaging. right?" title="" data-toggle="popover" class="btn btn-large btn-danger" href="#" data-original-title="A Title">Click to toggle popover</a>
        </div>

<script>
$('#pover').popover('toggle')
</script>
...
<div id="myCarousel" class="carousel slide" style="width: 500px;">
  ...
  <div class="carousel-inner">
    <div class="active item"><img src="http://newschoolnetwork.com/moodle/26/theme/image.php?theme=bcu&component=theme&image=market2"></div>
    <div class="item"><img src="http://newschoolnetwork.com/moodle/26/theme/image.php?theme=bcu&component=theme&image=market3"></div>
    <div class="item"><img src="http://newschoolnetwork.com/moodle/26/theme/image.php?theme=bcu&component=theme&image=market2"></div>
  </div>
  <!-- Carousel nav -->
