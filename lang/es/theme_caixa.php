...
<div class="well">
<h2>caixa</h2>
<p><img class="img-polaroid" src="caixa/pix/screenshot.png" /></p>
</div>
<div class="well">
<h2>Créditos</h2>
<h3>Acerca de...</h3>
<p>caixa es una plantilla para Moodle, de dos columnas y tipo responsive, altamente personalizable y basada en la popular plantilla BCU.</p>
...
<br>
<p>y otros desarrolladores, probadores, traductores y voluntarios (Ver <a href="caixa/README.txt" target="_blank">README.txt</a>)</p>
<br>
<h3>Informar de errores</h3>
<p>Puedes informar de errores encontrados en este tema (y por favor, sólo errores) a través de nuestro <a href="https://bitbucket.org/covuni/moodle-theme_caixa/issues" target="_blank">repositorio en Bitbucket</a></p>
<br>
...
<br>
<h3>Demo</h3>
<p>Puedes ver una demostración del sitio y descargar un archivo de instalación en <a href="https://3-bits.com/demo/caixa">https://3-bits.com/demo/caixa</a></p>
<br>
...
$string['tickersettingsheading'] = 'Configura los anuncios de la página de inicio. Ver posición <a href="./caixa/pix/layout.png" target="_blank"> aquí</a>';
...
$string['tickertext1desc'] = 'Añadir los anuncios en formato de lista HTML. Ver <a href="caixa/README.txt">README.txt</a> para más información.';

$string['tickertext2'] = 'Texto Anuncios 2';
$string['tickertext2desc'] = 'Añadir los anuncios en formato de lista HTML para un segundo tipo de usuario. Ver <a href="caixa/README.txt">README.txt</a> para más información.';
...
&#x3C;a href=&#x22;#&#x22; class=&#x22;submit&#x22;&#x3E;Por favor, haz caixa uno de tus temas favoritos&#x3C;/a&#x3E;
</pre>';
...
$string['marketingsettingsheading'] = 'Personaliza los bloques promocionales que aparecen en la página de inicio. Ver la distribución <a href="./../theme/caixa/pix/layout.png" target="_blank">aqui</a>';
...
para bloques y decidir cuantos bloques quieres mostrar y su distribución en la página de inicio. Puedes ver la distribución de las diferentes regiones en el archivo  <a href="/caixa/README.txt" target="_blank">README.txt</a>';
...
$string['marketdesc'] = 'Añade el código HTML del bloque promocional (ver el archivo <a href="./../theme/caixa/README.txt" target="_blank">README</a> para más ejemplos).';
...
$string['infoboxdesc'] = 'Añade el código HTML del cuadro informativo 1 (ver el archivo <a href="./../theme/caixa/README.txt" target="_blank">README</a> para más ejemplos)';
...
$string['infobox2desc'] = 'Añade el código HTML del cuadro informativo 2 (ver el archivo <a href="./../theme/caixa/README.txt" target="_blank">README</a> para más ejemplos)';
...
$string['footnotedesc'] = 'Añade el código HTML del bloque de pie de página (ver el archivo <a href="./../theme/caixa/README.txt" target="_blank">README</a> para más ejemplos)';
...
$string['footercontentdesc'] = 'Añade el código HTML del bloque del pie de página (ver el archivo <a href="./../theme/caixa/README.txt" target="_blank">README</a> para más ejemplos)';
...
$string['sitetitletext'] = 'Nombre del sitio';
$string['sitetitletextdesc'] = 'Introducir el nombre del sitio que se mostrará en la cabecera (el nombre del sitio configurado en el apartado "Página Principal" no es mostrado por caixa)';
...
// Moodle/caixa version alert messages.
$string['beta'] = 'VERSION EN DESARROLLO. NO USAR EN SITIOS EN PRODUCCIÓN';
$string['deprecated'] = 'VERSIÓN DE MOODLE OBSOLETA. NO USAR caixa EN ESTE SITIO';
...
$string['tickertextdesc'] = 'Añade el texto a mostrar en la barra de anuncios en formato de lista. Ver el archivo <a href="caixa/README.txt">README.txt</a> para más información.';
