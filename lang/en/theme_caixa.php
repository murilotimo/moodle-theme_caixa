...
<h2>Credits</h2>
<h3>About</h3>
<p>caixa is a Moodle 2-columns responsive theme highly customizable and based in the popular BCU theme.</p>
...
<br>
<p>and many other developers, testers, translators and volunteers (See <a href="caixa/README.txt" target="_blank">README.txt</a>)</p>
<br>
<h3>Bugs Report</h3>
<p>You can report bugs (and please, <b>ONLY</b> bugs) in our <a href="https://bitbucket.org/covuni/moodle-theme_caixa/issues" target="_blank">Bitbucket repository</a></p>
<br>
...
<br>
<h3>Demo</h3>
<p>You can see a demo version <a href="https://3-bits.com/demo/caixa" target="_blank">HERE</a></p>
<br>
</div>
</div>';
...
$string['tickersettingsheading'] = 'Setup News Ticker on Front Page. See the layout <a href="./../theme/caixa/pix/layout.png" target="_blank"> here</a>';
...
$string['slideshowsettingsheading'] = 'Customize the carousel on the front page. See the layout <a href="./../theme/caixa/pix/layout.png" target="_blank"> here</a>';
...
$string['marketingsettingsheading'] = 'Customize the marketing blocks that appear on the front page. See the layout <a href="./../theme/caixa/pix/layout.png" target="_blank"> here</a>';
$string['marketingdesc'] = 'There are two full width info boxes with differing styles you can use.
In addition to this there is a layout builder allowing you to decide how many blocks you need and define your own layout, please see the <a href="./../theme/caixa/README.txt" target="_blank">README</a> file that comes with this theme.';
...
$string['marketdesc'] = 'Add html for marketing block (see the <a href="./../theme/caixa/README.txt" target="_blank">README</a> file for additional info and hints).';
...
$string['infoboxdesc'] = 'Frontpage info block HTML (see the <a href="./../theme/caixa/README.txt" target="_blank">README</a> file for additional info and hints).';
...
$string['infobox2desc'] = 'Frontpage Secondary Info Box (see the <a href="./../theme/caixa/README.txt" target="_blank">README</a> file for additional info and hints).';
...
$string['footersettingsheading'] = 'Set the content that should appear in the footer. See the layout <a href="./../theme/caixa/pix/layout.png" target="_blank"> here</a> ';
...
$string['navbarmenusettingsheading'] = 'Customize the menu in the navigation bar. See the layout <a href="./../theme/caixa/pix/layout.png" target="_blank"> here</a>';
...
$string['headersettingsheading'] = 'Customize the header of this theme. See the layout <a href="./../theme/caixa/pix/layout.png" target="_blank"> here</a>';
$string['headerdesc'] = 'Upload your favicon, logo, set login form in header, adjust titles in header.<br />
You can set font size and styles for titles in the <a href="./../admin/settings.php?section=theme_caixa_font">fonts</a> settings page.';
...
You can set social icons under the <a href="./../admin/settings.php?section=theme_caixa_social">Header Social</a> settings page</strong>.';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'Upload a logo for use on your site. Recommended size is 310px x 60px';

$string['logocenter'] = 'Logo no Centro';
$string['logocenterdesc'] = 'Upload a logo for use on center of header. Recommended size is 200px x 80px';
...
$string['alertsettingsheading'] = 'Customize top Alert Box. See the layout <a href="./../theme/caixa/pix/layout.png" target="_blank"> here</a>';
...
$string['deprecated'] = 'MOODLE DEPRECATED VERSION. DO NOT USE caixa IN THIS SITE';
