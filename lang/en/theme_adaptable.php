...
$string['headerbgimagedesc'] = 'Set a background image for the header. Minimum size is 1600x180px and 1900x180px is recommended. The image cover the full header. You can add a colour to &#39;Top header background colour&#39; or use <i>transparent</i> to show the background image. In that case, modify the text colour to get displayed correctly over the image.';
