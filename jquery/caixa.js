jQuery(document).ready(function($) {
   ...
   $('.close').click(function(){
      ...
      if(alertkey!='undismissable'){
         M.util.set_user_preference('theme_caixa_alertkey' + alertindex, alertkey);
      }
    });
...
var onZoom = function() {
  ...
  if (zoomin) {
    ...
    M.util.set_user_preference('theme_caixa_zoom', 'nozoom');
  } else {
    Y.one('body').addClass('zoomin');
    M.util.set_user_preference('theme_caixa_zoom', 'zoomin');
  }
};

//When the button with class .moodlezoom is clicked fire the onZoom function
M.theme_caixa = M.theme_caixa || {};
M.theme_caixa.zoom =  {
  init: function() {
...
var onFull = function() {
    if ( $("#page").hasClass("fullin") ) {
        ...
        M.util.set_user_preference('theme_caixa_full', 'nofull');
    } else {
        $( "#page").addClass('fullin');
        //Y.one('#page').addClass('fullin');
        M.util.set_user_preference('theme_caixa_full', 'fullin');
    }
};
