    ...
    $.fn.tickerme = function (options)
    {
        ...
        return this.each(function ()
        {
            ...
            function init()
            {
                ...
                // Create the buttons:
                $('body')
                    .prepend(control_definitions)
                    .prepend(control_styles);
            ...
            function load_container()
            {
                ...
                {
                    $('#news')
                        .fadeOut(opts.fade_speed, function ()
                        {
                            $('#newscontent')
                                .html('<div id="news">' + contents[position] + '</div>');
                            $('#news')
                                .fadeIn(opts.fade_speed);
                        });
                }
            ...
            $('a#prev_trigger')
                .click(function ()
                {
                    ...
                    $('#newscontent')
                        .html('<div id="news" style="display:block">' + contents[position] + '</div>');
                    if (opts.auto_stop) {
                        $('a#pause_trigger')
                        .trigger('click');
                    }
